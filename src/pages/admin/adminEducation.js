...
const admin = () => {
  const api = "http://localhost:3000/Education";
  ...
  return `
        ...
        <a class = "text-btn mt-5 mb-5 " style ="padding:20px 50px" href="/admin/addEducation">Add</a>
         ...
         <tr>
           ...
           <td class="flex flex-col border border-slate-300">
             <a
               ...
               href="/admin/${index + 1}/updateEducation"
             >
               Update
             </a>
             <a
