...
const adminCategories = () => {
  ...
  return `
        ...
        <a class = "text-btn mt-5 mb-5 " style ="padding:20px 50px" href="/admin/addCategories">Add</a>
     ...
     ${products
       .map((product, index) => {
         ...
         <tr>
           ...
           <td class="flex items-center flex-col border border-slate-300">
             <a
               class="text-btn mt-5 mb-5 a"
               style="padding:20px 50px"
               href="/admin/${index + 1}/updateCategories"
             >
               Update
             </a>
             <a
